...
def Renewable_co2_2019_scatter(df_2019_energy_co2,kmeans):
    ...
    ax.scatter(selected1['Renewable_energy'], selected1['CO2'], label='Cluster 0',c='#0bb4ff')
    ax.scatter(selected2['Renewable_energy'], selected2['CO2'], label='Cluster 1',c="#dc0ab4")
    ...
    plt.title('Scatter Plot of Renewable Energy and CO2 Emissions by Cluster')
